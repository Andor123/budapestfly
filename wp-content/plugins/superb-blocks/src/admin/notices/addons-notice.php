...
<div class="notice notice-info is-dismissible <?php echo esc_attr($notice['unique_id']); ?>">
    ...
    <p>
        <a style='margin-bottom:15px;' class='button button-large button-primary' target='_blank' href='<?php echo esc_url(AdminLinkUtil::GetLink(AdminLinkSource::NOTICE)); ?>'><?php echo esc_html__("Unlock All Features", "superb-blocks"); ?></a>
    </p>
</div>
