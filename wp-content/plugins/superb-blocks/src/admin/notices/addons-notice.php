...
<div class="notice notice-info is-dismissible <?php echo esc_attr($notice['unique_id']); ?>">
    <h2 class="notice-title"><?php echo esc_html__("Lock in up to 50% off Superb Addons Premium", "superb-blocks"); ?></h2>
    <p>
        <?php echo esc_html__("Save up to 50% on the full Premium toolkit.", "superb-blocks"); ?>
